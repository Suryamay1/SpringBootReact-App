...
useEffect(() => {
  ...
  async function  Load()
  {
     const result = await axios.get(
         "http://localhost:8080/passengers/getAll");
    ...
    try
        {
         await axios.post("http://localhost:8080/passengers/save",
        {
          name: customername,
   ...
   async function editCustomer(customers)
   {
    ...
    setAddress(customers.city);
    setMobile(customers.phone); 
    setId(customers.id);
   }

   async function DeleteCustomer(customerid)
   {
        await axios.delete("http://localhost:8080/passengers/delete/" + customerid); 
   ...
   try
       {
        await axios.put("http://localhost:8080/passengers/update",
       {
        id: customerid,
        name: customername,
        city: customeraddress,
